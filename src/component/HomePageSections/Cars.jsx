            ...
            {filteredCars.map((car) => (
              ...
              >
                ...
                <div className="mt-auto flex">
                  <Link
                    href={`/cars/${car.id}`}
                    className="flex-1 bg-black text-white py-3 font-bold text-sm uppercase hover:bg-gray-800 transition"
                  >
                    Rent Car
                  </Link>
                  <Link
                    href={`/cars/${car.id}`}
                    className="flex-1 bg-[#ff5a30] text-white py-3 font-bold text-sm uppercase hover:bg-[#e04a20] transition"
                  >
                    Details
                  </Link>
                </div>
