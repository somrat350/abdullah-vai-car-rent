...
const Footer = () => {
  return (
    <div className="bg-[#1a0f0f] text-white py-20">
      <Container>
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          <div className="col-span-1 md:col-span-1">
            ...
            <div className="flex gap-4">
              <div className="size-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-primary cursor-pointer transition-all">
                <FaFacebookF />
              </div>
              <div className="size-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-primary cursor-pointer transition-all">
                <FaXTwitter />
          ...
          <div>
            ...
            <div className="flex">
              <input
                className="bg-white/5 border-none rounded-l-lg px-4 h-12 w-full focus:ring-0 focus:ring-primary outline-none"
                placeholder="Email address"
                type="email"
              />
              <button className="bg-primary px-4 rounded-r-lg h-12 hover:bg-[#ad3615] transition-colors">
